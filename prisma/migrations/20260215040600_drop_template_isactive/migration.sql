...
INSERT INTO "new_ChartTemplate" ("category", "clinicId", "createdAt", "deletedAt", "description", "fieldsConfig", "id", "isSystem", "name", "status", "type", "updatedAt") SELECT "category", "clinicId", "createdAt", "deletedAt", "description", "fieldsConfig", "id", "isSystem", "name", "status", "type", "updatedAt" FROM "ChartTemplate";
