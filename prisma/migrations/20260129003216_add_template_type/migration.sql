...
INSERT INTO "new_ChartTemplate" ("category", "clinicId", "createdAt", "deletedAt", "description", "fieldsConfig", "id", "isActive", "isSystem", "name", "updatedAt") SELECT "category", "clinicId", "createdAt", "deletedAt", "description", "fieldsConfig", "id", "isActive", "isSystem", "name", "updatedAt" FROM "ChartTemplate";
